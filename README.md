...
- `schermate/direzioni/` — prime schermate reali: tre direzioni per la vista principale dell'azienda, prova a 40 dipendenti, direzione scelta (A · Console) con home, pagine Richieste, Dipartimento, Dipendente, Esecuzione, Costi, Agenda e Chat, e il telefono del titolare (`mobile.html`: Da approvare, Richiesta con la revisione di performance, Riepilogo di oggi, Chat, Conversazione, Agenda, Dipartimenti e Dipartimento). Dal 2026-09-06 la barra «Oggi in azienda» in cima alla Console è il quadro del giorno in quattro caselle contate (studio UX, versione 16 con la correzione 16a); dal 2026-09-07 il quadro c'è anche in cima al telefono, ridotto a una riga di tre caselle (versione 17), e **i controlli si vedono solo se fanno quello che promettono**: la ricerca di sezione filtra davvero dove serve, le pillole filtrano, i cerchi vuoti sono spariti. Studio in `DIREZIONI.md`. Le prove cliccate con Playwright in `schermate/direzioni/prove/` e le catture rigenerabili con `schermate/direzioni/scatta.js`.
