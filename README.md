...
- `schermate/direzioni/` — prime schermate reali: tre direzioni per la vista principale dell'azienda, prova a 40 dipendenti, direzione scelta (A · Console) con home, pagine Richieste, Dipartimento, Dipendente ed Esecuzione, e le approvazioni da mobile (`mobile.html`: Da approvare, Richiesta con la revisione di performance, Riepilogo di oggi). Studio in `DIREZIONI.md`.
