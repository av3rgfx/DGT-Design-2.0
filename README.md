...
- `schermate/direzioni/` — prime schermate reali: tre direzioni per la vista principale dell'azienda, prova a 40 dipendenti, direzione scelta (A · Console) con home, pagine Richieste, Dipartimento, Dipendente, Esecuzione, Costi, Agenda e Chat, e il telefono del titolare (`mobile.html`: Da approvare, Richiesta con la revisione di performance, Riepilogo di oggi, Chat, Conversazione, Agenda). Dal 2026-09-06 la barra «Oggi in azienda» in cima alla Console è il quadro del giorno in caselle contate (studio UX, versione 16). Studio in `DIREZIONI.md`. Le prove cliccate con Playwright in `schermate/direzioni/prove/` e le catture rigenerabili con `schermate/direzioni/scatta.js`.
