...
20. **Le approvazioni da mobile** (2026-09-05, versione 11, prima metà): il titolare approva dal telefono nella cornice mobile
    ...
    non cambia colore per distinguersi dalle card lime, è il fondo sotto la barra a farsi da parte (correzione dell'utente). Le revisioni di performance restano alla Console finché il confronto delle versioni non è disegnato sul telefono.
